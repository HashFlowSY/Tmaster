...
**Status:** done (commit c3d6ced) — 代码 + 自动化（canSubmitBirth 8 例）全绿；中性默认/农历敬请期待/稍后出口真机人工核对由用户通过 ✓（2026-08-08）
...
- [x] 真机人工核对（用户完成 ✓ 2026-08-08）：中性默认下无法盲提交、农历弹「敬请期待」、稍后可离开、占位/文案观感正确。
